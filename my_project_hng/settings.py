"""
Django settings for my_project_hng project.
...
# CSRF_TRUSTED_ORIGINS = ['https://dreamerhngtask-production.up.railway.app', '127.0.0.1']
...
WSGI_APPLICATION = 'my_project_hng.wsgi.application'
